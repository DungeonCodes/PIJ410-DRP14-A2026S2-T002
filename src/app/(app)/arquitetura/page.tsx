// -----------------------------------------------------------------------------
// FASE 4 — PREPARADO NO CÓDIGO, NÃO DISPONÍVEL AO USUÁRIO.
// -----------------------------------------------------------------------------
...
// 'arquitetura' estiver 'habilitado: false' em 'src/lib/fases.ts', esta página
...
export default function ArquiteturaPage() {
  exigirModuloHabilitado('arquitetura');
